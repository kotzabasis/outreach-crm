...
export const EN = {
  ...
  // --- UX features batch: palette, command palette, segments, body A/B, conversation, undo, dark mode ---
  "Πήγαινε ή κάνε ενέργεια…": "Go to or run an action…",
  "Κανένα αποτέλεσμα.": "No results.",
  "επαφή": "contact",
  "Συνομιλία": "Conversation",
  "Καμία επικοινωνία ακόμα.": "No activity yet.",
  "Αίτημα σύνδεσης LinkedIn": "LinkedIn connection request",
  "Μήνυμα LinkedIn": "LinkedIn message",
  "Όνομα segment:": "Segment name:",
  "Το segment αποθηκεύτηκε.": "Segment saved.",
  "Segments…": "Segments…",
  "Διαγραφή segment": "Delete segment",
  "Αποθήκευση segment": "Save segment",
  "A/B κειμένου": "Body A/B",
  "Παραλλαγή κειμένου": "Body variant",
  "Κάθε αποστολή διαλέγει τυχαία ένα κείμενο. Νικητής: Analytics → A/B.": "Each send picks a body at random. Winner: Analytics → A/B.",
  "Drop-off ανά βήμα": "Drop-off by step",
  "{n}% open": "{n}% open",
  "Round-robin (extra links)": "Round-robin (extra links)",
  " · {n} στη ρότα": " · {n} in rotation",
  "Προσθήκη link": "Add link",
  "Διαγράφηκαν {n} επαφές.": "Deleted {n} contacts.",
  "Αναίρεση": "Undo",
  "Η προσφορά διαγράφηκε.": "Offer deleted.",
  "Το template διαγράφηκε.": "Template deleted.",
  "Το campaign διαγράφηκε.": "Campaign deleted.",
  "Περισσότερα": "More",
  "Κείμενο {v}": "Body {v}",
  " (κύριο)": " (primary)",
  " · νικητής ✓": " · winner ✓",
  "{sent} στάλθηκαν · {opened} ανοίγματα": "{sent} sent · {opened} opens",
  "Δεν υπάρχουν ακόμα A/B tests. Πρόσθεσε εναλλακτικά θέματα ή κείμενα σε ένα βήμα sequence ή σε ένα campaign για να ξεκινήσεις.": "No A/B tests yet. Add alternative subjects or bodies to a sequence step or a campaign to start.",
  "Φωτεινό θέμα": "Light theme",
  "Σκούρο θέμα": "Dark theme",
  "Φωτεινό": "Light",
  "Σκούρο": "Dark",
  "Εμφάνιση": "Appearance",
};
